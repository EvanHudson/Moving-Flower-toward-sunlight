//#include "speaker_test_rick.h"
int song=0;

//1mario, 2cantina, 3starwars, 4imperial,5MII channel, 6pacman, 7pink panther, 8nokia,9take on me, 10lion song, 11tetris, 12greensleeves, 13cannon ind , 14ode to joy, 15prince igor, 16jingle bells, 17frosty the snow man, 18 rudolph the rednose reindeer, 19 wish you merry cchristmas,20 rick 
//21 silent night, 22 doom, 23 happy birthday
...
int melody[] = {
  ...
  // Jingle Bells
  NOTE_E4, 4, NOTE_E4, 4, NOTE_E4, 8, NOTE_E4, 8,
  NOTE_E4, 4, NOTE_E4, 4, NOTE_E4, 8, NOTE_G4, 8,
  NOTE_C4, 4, NOTE_D4, 4, NOTE_E4, 2,
  NOTE_F4, 4, NOTE_F4, 4, NOTE_F4, 8, NOTE_F4, 8,
  NOTE_F4, 4, NOTE_E4, 4, NOTE_E4, 8, NOTE_D4, 8,
  NOTE_D4, 4, NOTE_E4, 4, NOTE_D4, 2,
  NOTE_E4, 4, NOTE_E4, 4, NOTE_E4, 8, NOTE_E4, 8,
  NOTE_E4, 4, NOTE_E4, 4, NOTE_E4, 8, NOTE_G4, 8,
  NOTE_C4, 4, NOTE_D4, 4, NOTE_E4, 2,
...
int melody[] = {
  // Frosty the Snowman
  NOTE_G4, 8, NOTE_G4, 8, NOTE_G4, 4,
  NOTE_G4, 8, NOTE_E4, 8, NOTE_G4, 4,
  NOTE_A4, 4, NOTE_A4, 4, NOTE_A4, 2,
  NOTE_A4, 4, NOTE_G4, 4, NOTE_F4, 4,
  
  NOTE_E4, -2, NOTE_D4, 8, NOTE_D4, 8, 
  NOTE_D4, -2, NOTE_E4, 8, NOTE_E4, 8, 
  NOTE_E4, 4, NOTE_E4, 4, NOTE_E4, 4,
  NOTE_E4, 4, NOTE_E4, 4, NOTE_F4, 4, 
...
int melody[] = {
  ...
  NOTE_G4, 4, NOTE_A4, 4, NOTE_B4, -2,
  NOTE_E5, 4, NOTE_E5, 4, NOTE_E5, 2,
  NOTE_E5, 4, NOTE_D5, 4, NOTE_D5, 4,
  
  NOTE_C5, -2, NOTE_D5, 4, NOTE_E5, 4,
  NOTE_E5, -2, NOTE_E5, 4, NOTE_F5, 4,
  NOTE_E5, 8, NOTE_D5, 8, NOTE_C5, 2,
  NOTE_C5, 4, NOTE_A4, 4, NOTE_B4, 4,
  
  NOTE_G4, 4, NOTE_G4, 4, NOTE_G4, 4,
  NOTE_G4, 4, NOTE_A4, 4, NOTE_B4, -2,
  NOTE_E5, 4, NOTE_E5, 4, NOTE_E5, 2,
  NOTE_E5, 4, NOTE_D5, 4, NOTE_D5, 4
};
